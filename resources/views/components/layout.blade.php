...
<html lang="en">
  <head>
    ...
    <title>
      @isset($docTitle)
        {{$docTitle}} | PixelMotion Test
      @else
        PixelMotion Test
      @endisset
    </title>
    <link rel="icon" href="https://www.pixelmotion.com/wp-content/uploads/2019/03/cropped-pixelmotion-logo-32x32.png" type="image/icon type">
  ...
  <body>
    <header class="header-bar mb-3 fixed-top" id="main-header">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        ...
        <div class="flex-row my-3 my-md-0">
          ...
          <a class="btn btn-sm btn-primary mr-2" href="/create-post">Create Post</a>
    ...
    <footer class="border-top text-center small text-muted py-3">
        <p class="m-0">Welmann Paniagua &copy; {{date('Y')}} <a href="/" class="text-muted">SimpleApp</a>. Laravel Test for Pixelmotion.</p>
      </footer>
